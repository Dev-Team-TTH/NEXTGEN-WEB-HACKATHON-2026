    ...
    >
      ...
      <div className="relative z-10 flex items-stretch gap-3.5 sm:gap-4">
        ...
        <div className="flex flex-col justify-center py-0.5">
          {/* 🚀 ĐÃ LOẠI BỎ HARDCODE: Dùng màu chuẩn text-slate-900 để CSS Polyfill quản lý */}
          <h1 className="text-2xl sm:text-[28px] lg:text-3xl font-black tracking-tight text-slate-900 leading-none">
            {title}
          </h1>
          {subtitle && (
            <p className="text-[13px] sm:text-sm font-semibold text-slate-500 mt-1.5 sm:mt-2 max-w-xl leading-relaxed">
              {subtitle}
            </p>
          )}
        </div>
