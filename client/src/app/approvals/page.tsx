...
import { 
  ...
  ShieldCheck, User, Filter, Eye, RotateCcw
} from "lucide-react";
        ...
        rightNode={
          <div className="flex items-center gap-2 p-1 bg-slate-100 dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-white/5 overflow-x-auto">
            <button 
              ...
              className={`relative px-4 py-2.5 text-sm font-bold rounded-lg transition-colors z-10 flex items-center gap-2 whitespace-nowrap ${activeBoard === "PENDING_APPROVALS" ? "text-indigo-700 dark:text-indigo-400" : "text-slate-500 hover:text-slate-700 dark:hover:text-slate-300"}`}
            >
            ...
            <button 
              ...
              className={`relative px-4 py-2.5 text-sm font-bold rounded-lg transition-colors z-10 flex items-center gap-2 whitespace-nowrap ${activeBoard === "MY_REQUESTS" ? "text-indigo-700 dark:text-indigo-400" : "text-slate-500 hover:text-slate-700 dark:hover:text-slate-300"}`}
            >
