...
export default function AdvancedAssetOperationsModal({ isOpen, onClose }: AdvancedOperationsProps) {
  ...
  // --- OVERRIDE CORE MODAL STYLING TẠO GIAO DIỆN APP ---
  // Modal này khá đặc biệt vì nó có Sidebar riêng, nên chúng ta sẽ ẩn Header/Footer mặc định của Core Modal.
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="" // Không dùng Header của Modal
      maxWidth="max-w-5xl"
      disableOutsideClick={isProcessing}
      // Dùng class trống để giấu header/footer mặc định
      hideHeader={true} 
      hideFooter={true}
    >
      <div className="flex flex-col md:flex-row h-[85vh] w-full relative">
        ...
        <div className="w-full md:w-64 bg-white dark:bg-[#0B0F19] border-r border-slate-200 dark:border-white/10 shrink-0 flex flex-col shadow-[10px_0_20px_rgba(0,0,0,0.02)] z-20">
          ...
          <div className="p-4 border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-slate-900/50 mt-auto">
                  ...
                  <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col gap-5">
                    <div className="space-y-1.5 group">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-purple-500 font-semibold shadow-sm"
                      >
                      ...
                      <div className="space-y-1.5 group">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full pl-9 pr-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-lg font-black text-purple-700 dark:text-purple-400 focus:ring-2 focus:ring-purple-500 outline-none disabled:opacity-50 shadow-inner"
                          />
                        </div>
                      </div>
                      <div className="space-y-1.5 group">
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-sm focus:ring-2 focus:ring-purple-500 outline-none disabled:opacity-50 shadow-sm"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col gap-5">
                    <div className="space-y-1.5 group">
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-amber-500 font-semibold shadow-sm"
                      >
                      ...
                      <div className="space-y-1.5 group">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full pl-9 pr-4 py-3 bg-amber-50/50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-500/30 rounded-xl text-lg font-black text-amber-700 dark:text-amber-400 focus:ring-2 focus:ring-amber-500 outline-none disabled:opacity-50 shadow-inner"
                          />
                        </div>
                      </div>
                      <div className="space-y-1.5 group">
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-sm focus:ring-2 focus:ring-amber-500 outline-none disabled:opacity-50 shadow-sm"
                        />
                      </div>
                    </div>
                  </div>
